...
Everyone is - at least at the end of your educational program - going to have to solve a novel problem. I am of course referring to writing your thesis which will deal with a topic that is not yet solved. You need to have a clear way of thinking to solve that problem, even if your thesis doesn't have anything to do with programming. 

### How do we solve problems in our everyday life?
Problem solving is happening in our brains every second of every day, but most of it happens so quickly and smoothly that we don't notice it. We also have the added benefit that in our local environment, there are many assumptions we make because the more time we spend in an environment, the more efficient our behavior becomes. For example, suppose you are talking to a friend with whom you grew up in the same town. Both of you know that layout of that town quite well because you grew up there. So if you were giving your friend directions in that town, you could say "turn left by that old house on the corner". Your friend would understand the reference because they have prior knowledge of what you are talking about. However, if you were explaining the same directions to someone from out of town, they wouldn't necessary know what you're talking about.

You might be wondering, how does this relate to problem solving? The process of problem solving means breaking a problem into smaller steps - this is known as decomposition. Before you can do that, you need to understand that your brain has made your thinking process as efficient as possible by eliminating redundancy i.e. your friend already knows where the old house is, so why would you explain it again? The problem is that when you are trying to solve ################

### Templates as a concept of problem solving
Solving a problem in the context of a course exercise does not provide any concrete solutions to real world problems because the problem has already been solved - by the authors of the course and/or the teacher running the lecture. So, what's the point of doing it? Solving the problem creates a template in your mind. This template can be used to solve other problems that are similar or the template can serve a baseline which can be customized to the new problem. This is a process called "pattern recognition".  
